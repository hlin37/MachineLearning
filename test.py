...
# Create the main CTkTabview (parent)
main_notebook = ctk.CTkTabview(master=app)
main_notebook.pack(expand=True, fill="both")

# Create tabs for the main notebook
main_tab1 = ctk.CTkFrame(main_notebook)
main_tab2 = ctk.CTkFrame(main_notebook)

main_notebook.add("1")
main_notebook.add("2")

# Create a nested CTkTabview within Main Tab 1
nested_notebook = ctk.CTkTabview(master=main_tab1)
nested_notebook.pack(expand=True, fill="both")

# Create tabs for the nested notebook
nested_tab1 = ctk.CTkFrame(nested_notebook)
nested_tab2 = ctk.CTkFrame(nested_notebook)

nested_notebook.add("3")
nested_notebook.add("4")
